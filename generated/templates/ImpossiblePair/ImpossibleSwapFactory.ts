...
export class ImpossibleSwapFactory extends ethereum.SmartContract {
  static bind(address: Address): ImpossibleSwapFactory {
    return new ImpossibleSwapFactory("ImpossibleSwapFactory", address);
  }
